...
class OrderModel {
  ...
  OrderModel copyWith({
    ...
    double? customerLat,
    double? customerLng,
    String? unboxingOption,
    String? checkedInvoices,
