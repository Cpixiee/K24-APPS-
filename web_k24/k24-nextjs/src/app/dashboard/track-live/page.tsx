...
function TrackLiveNotificationPageContent() {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl bg-card p-6 border border-border shadow-sm">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-2 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 px-3 py-1 text-xs font-bold text-emerald-600 dark:text-emerald-400 border border-emerald-500/20">
              ...
              PUSAT NOTIFIKASI & LOG PENGIRIMAN
            </div>
            <h2 className="text-2xl font-bold tracking-tight text-foreground">Notifikasi & Laporan Status Order</h2>
            <p className="text-xs text-muted-foreground">
              Riwayat lengkap laporan status penjemputan apotek, pengantaran kurir jalan, dan penyelesaian order.
            </p>
          </div>
          ...
          {visibleNotifications.length === 0 ? (
            <div className="flex h-64 items-center justify-center text-center p-6">
              <div>
                ...
                <h3 className="font-bold text-foreground text-sm">Belum Ada Notifikasi</h3>
  ...
  return (
    <Suspense fallback={
      <div className="flex h-64 items-center justify-center rounded-2xl border border-border bg-card">
        <p className="text-xs font-medium text-muted-foreground">Memuat notifikasi...</p>
      </div>
    }>
      <TrackLiveNotificationPageContent />
    </Suspense>
  )
}
