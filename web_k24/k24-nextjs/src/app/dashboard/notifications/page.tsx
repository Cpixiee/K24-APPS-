...
import {
  Bell, CheckCheck, CheckCircle2, Truck, Package, Radio, ArrowRight, RefreshCw, ChevronDown
} from 'lucide-react'
...
function getNotificationTheme(titleStr: string, messageStr: string) {
  ...
  if (text.includes('selesai') || text.includes('completed') || text.includes('done') || text.includes('pod')) {
    return {
      ...
      badgeColor: 'text-emerald-700 bg-emerald-100 dark:bg-emerald-950/60',
    }
  }
  if (text.includes('pengantaran') || text.includes('delivering') || text.includes('kurir jalan') || text.includes('antar')) {
    return {
      ...
      badgeColor: 'text-blue-700 bg-blue-100 dark:bg-blue-950/60',
    }
  }
  if (text.includes('penjemputan') || text.includes('pickup') || text.includes('tugas') || text.includes('faktur')) {
    return {
      ...
      badgeColor: 'text-amber-700 bg-amber-100 dark:bg-amber-950/60',
    }
  }
  if (text.includes('tiba') || text.includes('lokasi') || text.includes('arrived')) {
    return {
      ...
      badgeColor: 'text-purple-700 bg-purple-100 dark:bg-purple-950/60',
    }
  }
    ...
    <div className="space-y-6 pb-12 max-w-5xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border pb-3">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-600 hover:text-emerald-500 transition shrink-0"
        >
